    ...
    methods: {
        ...
        form_1_on_submit: function(){
            ...
            if (this.error_username == false && this.error_image_code == false) {
                axios.get(this.host+'/users/' + this.username + '/sms/token/?text='+ this.image_code + '&image_code_id=' + this.image_code_id, {
                        responseType: 'json'
                    })
                    .then(response => {
        ...
        form_2_on_submit: function(){
            ...
            if (this.error_sms_code == false) {
                axios.get(this.host + '/users/' + this.username + '/password/token/?sms_code=' + this.sms_code, {
                        responseType: 'json'
                    })
                    .then(response => {
