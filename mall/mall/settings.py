...
SECRET_KEY = 'mz5@w8ttpw4cjp_7(=cfear%rz!l5!dwrtjost)flml+%e9=ry'
...
# FastDFS
FDFS_URL = 'http://106.13.74.242:8888/'  # 访问图片的路径域名 ip地址修改为自己机器的ip地址
...
CRONJOBS = [
    ...
    ('*/1 * * * *', 'contents.crons.generate_static_index_html',
     ...
     '>> /Users/hanjing/Documents/study/testcode/xiangmu/duoduo/mall/logs/crontab.log')
]
# 解决crontab中文问题
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://106.13.74.242:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
