...
#     password = serializers.CharField(label='当前密码', required=True, allow_blank=False, write_only=True)
#     password1 = serializers.CharField(label='新密码', required=True, allow_blank=False, write_only=True)
#     password2 = serializers.CharField(label='确认密码', required=True, allow_blank=False, write_only=True)
#
#     class Meta:
#         model = User
